...
RAXION  is a fully-featured Discord bot with a modern web dashboard for managing everything from antinuke to music. Built on `discord.py v2`, `FastAPI`, and `Next.js 14` with Tailwind CSS.

```
RAXION -CV2-With-Dashboard/
...
```bash
git clone https://github.com/RayExo/RAXION -CV2-With-Dashboard
cd RAXION -CV2-With-Dashboard/bot
```
...
2. Choose **Cloudflared**, give it a name (e.g. `RAXION -api`), save
